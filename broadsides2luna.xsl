...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="mods:mods">
        <xsl:for-each select=".">
            ...
            <xsl:variable name="nq">Nicaragua</xsl:variable>
            <xsl:variable name="gt">Guatemala</xsl:variable>
            <xsl:variable name="ho">Honduras</xsl:variable>
            <xsl:variable name="es">Spain</xsl:variable>
            <xsl:variable name="cr">Costa Rica</xsl:variable>
            <xsl:variable name="py">Paraguay</xsl:variable>
            <xsl:variable name="fr">France</xsl:variable>
            <xsl:variable name="mx">Mexico</xsl:variable>
